// Bluebird 3.0.0 By Louy Alakkad (http://louy.alakkad.me)
...
declare class Promise<R> implements Promise.Thenable<R>, Promise.Inspection<R> {
	...
	then<U>(onFulfill: (value: R) => U|Promise.Thenable<U>, onReject?: (error: any) => void|Promise.Thenable<void>): Promise<U>;
	 ...
	 */
	nodeify(callback: (err: any, value?: R) => void, options?: Promise.SpreadOption): void;
	nodeify(...sink: any[]): void;
	asCallback(callback: (err: any, value?: R) => void, options?: Promise.SpreadOption): void;
	...
	* });
	...
	/*
	 ...
	 spread<U, W>(fulfilledHandler: (...values: W[]) => Promise.Thenable<U>, onReject?: (reason: any) => Promise.Thenable<U>): Promise<U>;
	 spread<U, W>(fulfilledHandler: (...values: W[]) => Promise.Thenable<U>, onReject?: (reason: any) => U): Promise<U>;
	 spread<U, W>(fulfilledHandler: (...values: W[]) => U, onReject?: (reason: any) => Promise.Thenable<U>): Promise<U>;
	 spread<U, W>(fulfilledHandler: (...values: W[]) => U, onReject?: (reason: any) => U): Promise<U>;
	 */
	/**
	...
	static attempt<R>(fn: () => Promise.Thenable<R>): Promise<R>;
	static attempt<R>(fn: () => R): Promise<R>;
